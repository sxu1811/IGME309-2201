...
void Application::Display(void)
{
	...
	matrix4 m4OrientX = glm::rotate(IDENTITY_M4, m_qOrientation.x, vector3(1.0f, 0.0f, 0.0f));
	matrix4 m4OrientY = glm::rotate(IDENTITY_M4, m_qOrientation.y, vector3(0.0f, 1.0f, 0.0f));
	matrix4 m4OrientZ = glm::rotate(IDENTITY_M4, m_qOrientation.z, vector3(0.0f, 0.0f, 1.0f));
